...
export default function SummaryCompletionRenderer({
  questionGroup,
  answers,
  onAnswerChange,
}: SummaryCompletionRendererProps) {
  ...
  const renderSummaryWithGaps = () => {
    ...
    // Split the summary text by numbered gaps (1), (2), etc.
    const parts = questionGroup.summaryText.split(/\((\d+)\)/);
    const elements = [];
