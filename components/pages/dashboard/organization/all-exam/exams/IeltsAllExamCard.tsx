...
export function IeltsAllExamCard({
  exam,
  onViewDetails,
  onDelete,
  isDeleting = false,
  ...
  return (
    <>
                ...
                <div className="space-y-1">
                  ...
                  {exam.speaking_group.time_windows.length > 2 && (
                    <div className="text-xs text-muted-foreground">
                      +{exam.speaking_group.time_windows.length - 2} more slots
                    </div>
                  )}
                </div>
              </div>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Delete IELTS Exam</DialogTitle>
            <DialogDescription>
              Are you sure you want to delete &ldquo;{exam.title}&rdquo;? This
              action cannot be undone and will remove all associated test
              schedules.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
