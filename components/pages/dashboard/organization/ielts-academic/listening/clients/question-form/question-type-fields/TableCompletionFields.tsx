...
interface TableCompletionFieldsProps {
  ...
  updateQuestionGroup: (data: Partial<ListeningTableCompletionGroup>) => void;
}
...
export default function TableCompletionFields({
  ...
  // Ensure we have arrays for tableStructure and questions
  const tableStructure = Array.isArray(questionGroup.tableStructure)
