        ...
        <div className="px-4 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>{stats?.summary.totalQuestions || 0} Questions total</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="space-y-4">
            <Link
              href={`/dashboard/organization/${organizationId}/ielts-academic/listening/tests/${test.id}/preview`}
              className="w-full"
            >
            ...
            <div className="flex gap-3">
              <Link
                href={`/dashboard/organization/${organizationId}/ielts-academic/listening/tests/${test.id}/edit`}
                className="flex-1"
              >
