...
import { BookOpen, CheckCircle2, Edit, Eye, FileQuestion } from "lucide-react";
            ...
            <TooltipTrigger asChild>
              ...
              >
                <Link
                  href={
                    firstGroupId
                      ? `/dashboard/organization/${organizationId}/ielts-academic/reading/questions/${firstGroupId}`
                      : "#"
                  }
                  aria-disabled={!firstGroupId}
                  tabIndex={!firstGroupId ? -1 : undefined}
                ...
                >
                  ...
                  <span className="whitespace-nowrap">View Questions</span>
                </Link>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
