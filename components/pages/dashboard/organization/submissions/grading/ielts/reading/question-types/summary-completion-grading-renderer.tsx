...
import { SummaryCompletionGroup } from "@/types/exam/ielts-academic/reading/question/question";
...
interface SummaryCompletionGradingRendererProps {
  questionGroup: SummaryCompletionGroup;
...
export default function SummaryCompletionGradingRenderer({
  questionGroup,
  userAnswers,
  manualGrades,
  onManualGradeChange,
  getFinalGradeStatus,
}: SummaryCompletionGradingRendererProps) {
  ...
  // Helper function to render summary with highlighted gaps
  const renderSummaryWithGaps = () => {
    if (!questionGroup.summaryText) {
      return (
    ...
    let summaryText = questionGroup.summaryText;
    ...
    questionGroup.questions.forEach((question) => {
      ...
      summaryText = summaryText.replace(gapPattern, replacement);
    });
