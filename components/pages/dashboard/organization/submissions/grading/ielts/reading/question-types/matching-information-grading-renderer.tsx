...
interface MatchingInformationGradingRendererProps {
...
export default function MatchingInformationGradingRenderer({
  questionGroup,
  userAnswers,
  manualGrades,
  onManualGradeChange,
  getFinalGradeStatus,
}: MatchingInformationGradingRendererProps) {
      ...
      <div className="bg-muted/30 rounded-lg p-3 sm:p-4">
        ...
        <div className="space-y-3 sm:space-y-4">
          {questionGroup.questions.map((question) => {
            ...
            const correctAnswer = question.correctParagraph;
