...
interface MatchingSentenceEndingsGradingRendererProps {
...
export default function MatchingSentenceEndingsGradingRenderer({
  questionGroup,
  userAnswers,
  manualGrades,
  onManualGradeChange,
  getFinalGradeStatus,
}: MatchingSentenceEndingsGradingRendererProps) {
  ...
  // Helper function to find ending text by label
  const getEndingText = (label: string): string => {
    if (!questionGroup.endings) return label;
    const ending = questionGroup.endings.find((e) => e.label === label);
    return ending ? ending.text : label;
  };
      ...
      <div className="bg-muted/30 rounded-lg p-3 sm:p-4">
          ...
          <div className="mb-4 p-3 bg-background rounded border">
            ...
            <div className="grid grid-cols-1 gap-2">
              {questionGroup.endings.map((ending) => (
                <div key={ending.label} className="flex items-start space-x-2">
        ...
        <div className="space-y-3 sm:space-y-4">
          {questionGroup.questions.map((question) => {
            ...
            const correctAnswer = question.correctEnding;
                    ...
                    <div className="mb-3">
                      ...
                      <div className="p-3 rounded border bg-muted/20">
                        <p className="text-sm font-medium text-foreground leading-relaxed">
                          ...
                          <span className="mx-1 text-blue-600 font-semibold">
                            ___
                          </span>
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-3 rounded border bg-muted/30 border-muted">
                          <div className="space-y-2">
                            ...
                            <div className="text-xs text-muted-foreground leading-relaxed">
                              <span className="italic">Complete sentence:</span>
                              <br />
                              {question.sentenceStart}{" "}
                              {getEndingText(correctAnswer)}
                            </div>
                          </div>
                        </div>
                      </div>
