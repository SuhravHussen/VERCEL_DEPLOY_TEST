...
interface FormCompletionGradingRendererProps {
...
export default function FormCompletionGradingRenderer({
  questionGroup,
  userAnswers,
  manualGrades,
  onManualGradeChange,
  getFinalGradeStatus,
}: FormCompletionGradingRendererProps) {
  ...
  const renderFormFieldWithBlank = (
    sentence: string,
    questionNumber: number
  ) => {
    const userAnswer = userAnswers.get(questionNumber) || "";
  ...
  return (
    <div className="space-y-2 sm:space-y-4">
      ...
      {/* Questions */}
      <div className="space-y-2 sm:space-y-4 border border-border rounded p-2 sm:p-4 md:p-6 bg-card shadow-sm">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                  <Label className="font-medium text-foreground text-xs sm:text-sm shrink-0 sm:w-20 lg:w-24">
                    {question.number}.
                  </Label>
                ...
                {/* Form field with filled answer */}
                <div className="ml-2 sm:ml-0 flex-1">
                  {renderFormFieldWithBlank(
